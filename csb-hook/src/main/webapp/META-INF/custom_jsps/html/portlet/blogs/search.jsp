...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/portlet/blogs/search.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
...
<aui:form action="<%= searchURL %>" method="get" name="fm">
	...
	>
		...
		>
            ...
            if(null != summary && null != entry.getContent()){

                try {
                    firstImageUrl =  JSONFactoryUtil.createJSONObject(HtmlUtil.unescape(entry.getContent())).getJSONArray("images").getJSONObject(0).getString("serverUrl");
			...
			<liferay-ui:app-view-search-entry
				...
				thumbnailSrc='<%= (!firstImageUrl.equals("")) ? firstImageUrl : StringPool.BLANK %>'
