...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/portlet/blogs/edit_entry.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
...
&lt;%&ndash;<link href="/html/metronic/assets/rtl/admin/layout2/css/layout.css" rel="stylesheet" type="text/css"/>&ndash;%&gt;
...
<%
    if(null != entry && null != entry.getTitle()){
        portletDisplay.setTitle(entry.getTitle());
    }
%>
...
*/
        ...
        $('#date_tile').showBalloon({ contents:$(".date_form").show() , position:"left" }).click(
            function(){
                if(!dateInitialized){
        ...
        $('#tags_tile').showBalloon({ contents:$(".tags_popup").show() , position:"left", classname:"my-balloon tags" }).click(
            function(){
                toggleBalloon($(this));
            }
        ).hideBalloon();
        ...
        $('#permission_tile').showBalloon({ contents:$("#permission_popup").show() , position:"left", classname:"my-balloon tags" }).click(
            function(){
                toggleBalloon($(this));
            }
        ).hideBalloon();
