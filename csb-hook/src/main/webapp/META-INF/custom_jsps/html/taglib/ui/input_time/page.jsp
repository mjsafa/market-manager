...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/taglib/ui/input_time/page.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
		...
		<c:otherwise>
            <div class="input-group big">
                ...
                <span class="twitter-typeahead">
                    ...
                    <input class="form-control" <%= disabled ? "disabled=\"disabled\"" : "" %> id="<%= namespace + name %>" name="<%= namespace + name %>" type="text" placeholder="<%= placeholder %>" value="<%= format.format(calendar.getTime()) %>" />
                </span>
            </div>
