...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/taglib/ui/input_field/page.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
