...
!function (a) {
    ...
    b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI", "TD"], b.LANGS = [], b.DEFAULTS = {allowedImageTypes:["jpeg", "jpg", "png", "gif"], alwaysBlank:!1, alwaysVisible:!1, autosave:!1, autosaveInterval:1e4, blockTags:["n", "p", "blockquote", "pre", "h1", "h2", "h3", "h4", "h5", "h6"], borderColor:"#252528", buttons:["bold", "italic", "underline", "strikeThrough", "fontSize", "fontFamily", "color", "sep", "formatBlock", "blockStyle", "align", "insertOrderedList", "insertUnorderedList", "outdent", "indent", "sep", "createLink", "insertImage", "insertVideo", "insertHorizontalRule", "undo", "redo", "html"], crossDomain:!0, customButtons:{}, customDropdowns:{}, customText:!1, defaultImageWidth:300, direction:"ltr", disableRightClick:!1, editorClass:"", headers:{}, height:"auto", icons:{}, inlineMode:!0, initOnClick:!1, language:"en_us", linkList:[], linkText:!0, linkClasses:{}, maxHeight:"auto", minHeight:"auto", noFollow:!0, paragraphy:!0, placeholder:"Type something", plainPaste:!1, preloaderSrc:"", saveURL:null, saveParams:{}, saveRequestType:"POST", simpleAmpersand:!1, shortcuts:!0, spellcheck:!1, theme:null, toolbarFixed:!0, trackScroll:!1, unlinkButton:!0, typingTimer:200, width:"auto", withCredentials:!1, zIndex:1e3}, b.prototype.destroy = function () {
        this.sync(), this.hide(), this.isHTML && this.html(), this.focus(), this.clearSelection(), this.$element.blur(), this.$bttn_wrapper && this.$bttn_wrapper.html("").removeData().remove(), this.$editor && this.$editor.html("").removeData().remove(), this.$image_editor && this.$image_editor.html("").removeData().remove(), this.$image_wrapper && this.$image_wrapper.html("").removeData().remove(), this.$link_wrapper && this.$link_wrapper.html("").removeData().remove(), this.$video_wrapper && this.$video_wrapper.html("").removeData().remove(), this.$popup_editor && this.$popup_editor.html("").removeData().remove(), this.$overlay && this.$overlay.html("").removeData().remove(), this.$image_modal && (this.hideMediaManager(), this.$image_modal.html("").removeData().remove()), this.isLink ? this.$element.removeData("fa.editable") : (this.$element.replaceWith(this.getHTML()), this.$box && !this.editableDisabled && (this.$box.removeClass("froala-box"), this.$box.find(".html-switch").remove(), this.$box.removeData("fa.editable"), clearTimeout(this.typingTimer))), clearTimeout(this.ajaxInterval), clearTimeout(this.typingTimer), this.$element.off("mousedown mouseup click keydown keyup focus keypress touchstart touchend touch drop"), this.$element.off("mousedown mouseup click keydown keyup focus keypress touchstart touchend touch drop", "**"), a(window).off("mouseup." + this._id), a(window).off("keydown." + this._id), a(window).off("keyup." + this._id), a(window).off("hide." + this._id), a(window).off("scroll." + this._id), a(document).off("selectionchange." + this._id), void 0 !== this.$upload_frame && this.$upload_frame.remove(), this.$textarea && (this.$box.remove(), this.$textarea.removeData("fa.editable"), this.$textarea.show())
    }, b.prototype.callback = function (b, c, d) {
        void 0 === d && (d = !0);
        var e = !0, f = b + "Callback";
        return this.options[f] && a.isFunction(this.options[f]) && (e = c ? this.options[f].apply(this, c) : this.options[f].call(this)), e = c ? this.$box.trigger("editable." + b, c) : this.$box.trigger("editable." + b), d === !0 && this.sync(), void 0 === e ? !0 : e
        ...
        if (!this.isHTML) {
            this.raiseEvent("sync"), this.disableImageResize(), this.isLink || this.isImage || this.$element.trigger("placeholderCheck"), this.isResizing() || this.isLink || this.isImage || this.options.editInPopup || this.android() || this.imageMode || this.cleanify();
            var a = this.getHTML();
            this.isHTML || (this.trackHTML !== a && null != this.trackHTML ? (this.callback("contentChanged", [], !1), this.refreshImageList(), this.refreshButtons(), this.trackHTML = a) : null == this.trackHTML && (this.trackHTML = a)), this.$textarea && this.$textarea.val(a)
        }
        ...
        this.browserFixes(), this.isImage || this.isLink || this.options.editInPopup || (this.initUndoRedo(), this.enableTyping(), this.initShortcuts()), this.initEditor(), this.isLink || this.initDrag(), this.initOptions(), this.initEditorSelection(), this.initAjaxSaver(), (!this.isLink || this.isImage) && (this.initImageResizer(), this.initImagePopup()), this.initLink(), this.setLanguage(), this.setCustomText(), this.isImage || this.isLink || this.registerPaste(), this.$element.blur(), this.initialized = !0, this.refreshButtons(!0), this.callback("initialized", [], !1)
        ...
        this.initElement(b), this.initElementStyle(), this.options.initOnClick ? (this.isLink || this.isImage || this.options.editInPopup || a(b).attr("contenteditable", !0), a(b).bind("mousedown", a.proxy(function () {
            a(b).unbind("mousedown"), a(b).attr("contenteditable", !1), this.saveSelectionByMarkers(), this.continueInit(), this.restoreSelectionByMarkers(), this.hideOtherEditors()
        ...
        if ("TEXTAREA" == b.tagName)this.$textarea = a(b), void 0 !== this.$textarea.attr("placeholder") && "Type something" == this.options.placeholder && (this.options.placeholder = this.$textarea.attr("placeholder")), this.$element = a("<div>").html(this.$textarea.val()), this.$textarea.before(this.$element).hide(), this.$textarea.parents("form").bind("submit", a.proxy(function () {
            this.isHTML ? this.html() : this.sync()
        }, this)); else if ("A" == b.tagName)this.isLink = !0, this.selectionDisabled = !0, this.editableDisabled = !0, this.options.buttons = [], this.$element = a(b), this.options.paragraphy = !1, this.$box = this.$element; else if ("IMG" == b.tagName) {
            var c = a(b).css("float");
        ...
        } else this.options.editInPopup ? (this.$element = a(b), this.$box = this.$element, this.editableDisabled = !0, this.options.buttons = [], this.$element.on("click", a.proxy(function (a) {
            a.preventDefault()
        }, this))) : ("DIV" != b.tagName && this.options.buttons.indexOf("formatBlock") >= 0 && this.disabledList.push("formatBlock"), this.$element = a(b));
        this.isImage || this.isLink || this.options.editInPopup || (this.$box = this.$element, this.$element = a("<div>"), this.setHTML(this.$box.html(), !1), this.$box.html(this.$element).addClass("froala-box"), this.$element.on("keyup", a.proxy(function (a) {
            var b = a.which;
        ...
        var b = [], c = ["SPAN", "A", "B", "I", "EM", "U", "S", "STRONG", "STRIKE", "FONT", "IMG"], d = this, e = function () {
            if (0 !== b.length) {
                var c;
        ...
        this.$element.get(0).onpaste = function () {
            if (!b.isHTML) {
                if (!b.callback("beforePaste", [], !1))return!1;
                b.pasting = !0, b.saveSelection();
                var c = a(window).scrollTop(), d = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; width: 0; z-index: 99999;"></div>').appendTo("body");
                d.focus(), window.setTimeout(function () {
                    var e = d.html();
                    d.remove(), a(window).scrollTop(c), b.restoreSelection(), b.insertHTML(b.options.plainPaste ? e.replace(/<(?!br\s*\/?)[^>]+>/g, "") : e.match(/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/gi) ? b.wordClean(e) : b.clean(e, !1, !0)), b.sync(), b.cleanify(), b.$element.trigger("placeholderCheck"), b.pasting = !1, b.callback("afterPaste")
                }, 1)
            }
        }
        ...
        var b = ["br", "button", "input", "img"], c = this.tagName(a);
        return b.indexOf(c) >= 0
    }, b.prototype.tabs = function (a) {
        for (var b = "", c = 0; a > c; c++)b += "  ";
        return b
    }, b.prototype.cleanTags = function (a) {
        var b, c, d, e, f = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "UL", "OL", "LI", "TABLE", "TBODY", "THEAD", "TFOOT", "TR", "TH", "TD"], g = [], h = [];
        for (a = a.replace(/\n/gi, ""), c = 0; c < a.length; c++)if (b = a.charAt(c), "<" == b) {
            var i = a.indexOf(">", c + 1);
            if (-1 !== i) {
                var j = a.substring(c, i + 1), k = this.tagName(j), l = this.isClosingTag(j);
                if (this.isSelfClosingTag(j))h.push(j); else if (l)for (d = !1, e = !0; d === !1 && void 0 !== e;)e = g.pop(), void 0 !== e && e.tag_name !== k ? h.splice(e.i, 1) : (d = !0, void 0 !== e && h.push(j)); else h.push(j), g.push({tag_name:k, i:h.length - 1});
                c = i
            }
        } else h.push(b);
        ...
        this.typingTimer = null, this.$element.on("keydown", a.proxy(function () {
            clearTimeout(this.typingTimer), this.ajaxSave = !1, this.oldHTML = this.getHTML(), this.typingTimer = setTimeout(a.proxy(function () {
                this.getHTML().replace(/[\u3041-\u3096]|[\u30A0-\u30FF]|[\u4E00-\u9FFF]/gi, "") != this.oldHTML.replace(/[\u3041-\u3096]|[\u30A0-\u30FF]|[\u4E00-\u9FFF]/gi, "") && (this.saveUndoStep(), this.sync())
        ...
        this.$element.find("a").data("fr-link", !0), c && this.$element.find("p, h1, h2, h3, h4, h5, h6, pre, blockquote, table, ul, ol, img").addClass("fr-tag"), this.$element.find(".f-img-editor > img").each(a.proxy(function (b, c) {
            this.addImageClass(a(c), this.getImageClass(a(c).parent().attr("class")))
        }, this));
        var d = this.$element.html();
        return this.$element.find(".f-img-editor > img").removeClass("fr-fin fr-fil fr-fir"), this.$element.find("p, h1, h2, h3, h4, h5, h6, pre, blockquote, table, ul, ol, img").removeClass("fr-tag"), d = this.syncCleanHTML(d, b), d = d.replace(/\s*contenteditable="[^"]*"/gi, ""), d = d.replace(/<a[^>]*?><\/a>/g, ""), b || (d = this.removeMarkersByRegex(d)), d = d.replace(/<span[^>]*? class\s*=\s*["']?f-img-handle[^>]+><\/span>/gi, ""), d = d.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-editor[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"), d = d.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-img-wrap[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"), d = d.replace(/^([\S\s]*)<span[^>]*? class\s*=\s*["']?f-video-editor[^>]+>([\S\s]*)<\/span>([\S\s]*)$/gi, "$1$2$3"), d = d.replace(/\&amp;/gi, "&"), this.options.simpleAmpersand && (d = d.replace(/\&amp;/gi, "&")), d = d.replace(/ data-fr-verified="true"/gi, ""), d = d.replace(/\n/gi, ""), d = d.replace(/\u200B/gi, "")
        ...
        if (!this.isHTML) {
            a && !this.pasting && (this.browser.webkit || this.$element.blur(), this.$element.focus()), this.pasting && !this.$element.is(":focus") && this.$element.focus();
            var c = this.getRange();
        ...
        if (this.isHTML || this.focus(), this.browser.msie) {
            var c, d;
        ...
        } else document.execCommand("inserthtml", null, a), this.focus()
        ...
        this.setDimensions(), this.setBorderColor(), this.isImage || this.isLink || (this.setPlaceholder(), this.setPlaceholderEvents()), this.setSpellcheck(), this.setImageUploadURL(), this.setButtons(), this.setDirection(), this.setTextNearImage(), this.setZIndex(), this.setTheme(), this.options.editInPopup && this.buildEditPopup()
        ...
        a(window).on("hide." + this._id, a.proxy(function () {
            ...
            !c && this.$popup_editor.is(":visible") && (this.hide(), this.closeImageMode())
        ...
        for (var e in b.options) {
            var f = a('<a href="#">' + e + "</a>"), g = a("<li>").append(f);
        ...
        this.$bttn_wrapper.on("mouseup touchend", ".fr-dropdown .fr-trigger", function (c) {
            ...
            this.$bttn_wrapper.find(".fr-dropdown .fr-trigger").removeClass("active")
        }, this)), this.$bttn_wrapper.find(".fr-selector button.fr-bttn").bind("select",
            function () {
        ...
        if (this.undoIndex > 1) {
            ...
            this.$element.html(b), this.restoreSelectionByMarkers(), this.callback("undo", [this.getHTML(), a]), "" !== this.text() ? this.repositionEditor() : this.hide(), this.refreshUndoRedo(), this.focus(), this.refreshButtons()
        }
    }, b.prototype.redo = function () {
        if (this.undoIndex < this.undoStack.length) {
            var a = this.$element.html(), b = this.undoStack[this.undoIndex++];
            this.$element.html(b), this.restoreSelectionByMarkers(), this.callback("redo", [this.getHTML(), a]), "" !== this.text() ? this.repositionEditor() : this.hide(), this.refreshUndoRedo(), this.focus(), this.refreshButtons()
        }
    }, b.prototype.save = function () {
        if (!this.callback("beforeSave", [], !1))return!1;
    ...
    a.Editable.commands = {bold:{title:"Bold", icon:"fa fa-bold", shortcut:"(Ctrl + B)"}, italic:{title:"Italic", icon:"fa fa-italic", shortcut:"(Ctrl + I)"}, underline:{cmd:"underline", title:"Underline", icon:"fa fa-underline", shortcut:"(Ctrl + U)"}, strikeThrough:{title:"Strikethrough", icon:"fa fa-strikethrough"}, formatBlock:{title:"Format Block", icon:"fa fa-paragraph", seed:[
    ...
    }}, a.Editable.prototype.exec = function (a, b, c) {
        var d = ["html", "undo", "redo", "selectAll", "save", "insertImage", "insertVideo", "insertTable"];
        if (!this.selectionInEditor() && d.indexOf(a) < 0)return!1;
        if (this.selectionInEditor()) {
            ...
            var e = ["insertHorizontalRule", "fontSize", "formatBlock", "blockStyle", "indent", "outdent", "justifyLeft", "justifyRight", "justifyFull", "justifyCenter", "html", "undo", "redo", "selectAll", "save", "insertImage", "insertVideo", "insertOrderedList", "insertUnorderedList", "insertTable", "insertRowAbove", "insertRowBelow", "deleteRow", "insertColumnBefore", "insertColumnAfter", "deleteColumn", "insertHeader", "deleteHeader", "insertCellBefore", "insertCellAfter", "deleteCell", "mergeCells", "splitHorizontal", "splitVertical", "deleteTable"];
            if ("" === this.text() && e.indexOf(a) < 0)return!1
        }
        this.execCommand[a] ? this.execCommand[a].apply(this, [a, b, c]) : this.execDefault(a, b);
        var f = ["undo", "redo", "selectAll", "createLink", "insertImage", "html", "insertVideo"];
        f.indexOf(a) < 0 && this.saveUndoStep(), "createLink" != a && "insertImage" != a && this.refreshButtons()
    }, a.Editable.prototype.html = function () {
        var a;
        this.isHTML ? (this.isHTML = !1, a = this.$html_area.val(), a = this.clean(a, !0, !1), this.$box.removeClass("f-html"), this.$html_area.blur(), this.no_verify = !0, this.$element.html(a), this.cleanify(!1), this.no_verify = !1, this.$element.attr("contenteditable", !0), this.$editor.find('.fr-bttn:not([data-cmd="html"]), .fr-trigger').prop("disabled", !1), this.$editor.find('.fr-bttn[data-cmd="html"]').removeClass("active"), this.saveUndoStep(), this.options.paragraphy && this.wrapText(), this.$element.blur(), this.focus(), this.refreshButtons(), this.callback("htmlHide", [a])) : (this.$element.removeClass("f-placeholder"), this.cleanify(!1), a = this.options.inlineMode ? "\n\n" + this.cleanTags(this.getHTML(!1, !1)) : this.cleanTags(this.getHTML(!1, !1)), a = a.replace(/\&amp;/g, "&"), this.$html_area.val(a).trigger("resize"), this.options.inlineMode && this.$box.find(".html-switch").css("top", this.$box.css("padding-top")), this.$html_area.css("height", this.$element.height() - 1), this.$element.html("").append(this.$html_area).removeAttr("contenteditable"), this.$box.addClass("f-html"), this.$editor.find('button.fr-bttn:not([data-cmd="html"]), button.fr-trigger').prop("disabled", !0), this.$editor.find('.fr-bttn[data-cmd="html"]').addClass("active"), this.hide(), this.imageMode = !1, this.isHTML = !0, this.$element.blur(), this.$element.removeAttr("contenteditable"), this.callback("htmlShow", [a]))
        ...
        for (var f, g = 0; g < e.length; g++) {
            var h = a(e[g]);
            if (!this.fakeEmpty(h))if (f = "n" == b ? this.options.paragraphy ? a("<div>").html(h.html()) : h.html() + "<br/>" : a("<" + b + ">").html(h.html()), h.get(0) != this.$element.get(0) && "LI" != h.get(0).tagName && "TD" != h.get(0).tagName && "TH" != h.get(0).tagName) {
                ...
                try {
                    if (h.hasClass(c))f.addClass(h.attr("class")).removeClass(c); else {
                        if (void 0 === h.attr("class") || void 0 === k || !this.options.blockStylesToggle && "toggle" != d)f.addClass(h.attr("class")); else for (var l = h.attr("class").split(" "), m = 0; m < l.length; m++) {
                            var n = l[m];
                            void 0 === k[n] && void 0 === d ? f.addClass(n) : void 0 !== k[n] && "toggle" === d && f.addClass(n)
                        }
                        "*" != c && f.addClass(c)
                    }
                } catch (o) {
        ...
        var c = !1;
        this.isActive(b) || (c = !0), this.saveSelectionByMarkers();
        for (var d, e = this.getSelectionElements(), f = !0, g = !1, h = 0; h < e.length; h++)if (d = a(e[h]), d.parents("li").length > 0 || "LI" == d.get(0).tagName) {
            var i;
            i = "LI" == d.get(0).tagName ? d : d.parents("li"), d.parents("ol").length > 0 ? (i.before('<span class="close-ol" data-fr-verified="true"></span>'), i.after('<span class="open-ol" data-fr-verified="true"></span>')) : d.parents("ul").length > 0 && (i.before('<span class="close-ul" data-fr-verified="true"></span>'), i.after('<span class="open-ul" data-fr-verified="true"></span>')), i.replaceWith(i.contents()), g = !0
        } else f = !1;
        if (g && (this.$element.find("ul, ol").each(function (b, c) {
            var d = a(c), e = "<" + c.tagName.toLowerCase() + ">" + d.html() + "</" + c.tagName.toLowerCase() + ">";
            ...
            for (var k = 0; k < e.length; k++)d = a(e[k]), d.get(0) != this.$element.get(0) && (j.append(a("<li>").append(d.clone())), k != e.length - 1 ? d.remove() : (d.replaceWith(j), j.find("li")));
            this.unwrapText()
        }
        ...
        c.length > 0 ? this.$link_wrapper.find('input[type="checkbox"]').prop("checked", "_blank" == a(c[0]).attr("target")) : this.$link_wrapper.find('input[type="checkbox"]').prop("checked", this.options.alwaysBlank), this.$link_wrapper.find(".f-external-link").attr("href", b || "#"), this.$link_wrapper.find('input[type="text"]').val(b.replace(/\&amp;/g, "&") || "http://")
    }, a.Editable.prototype.insertImage = function () {
        this.closeImageMode(), this.imageMode = !1, this.showInsertImage(), this.saveSelection(), this.options.inlineMode || this.positionPopup("insertImage"), this.imageMode = !1, this.$image_wrapper.find('input[type="text"]').val("")
    ...
    }, a.Editable.prototype.inlineStyle = function (b, c, d, e) {
        if (this.browser.webkit && "font-size" != b) {
            ...
            this.$element.find("span").each(function (b, c) {
                var d = a(c);
                d.attr("style") && f(d) && (d.data("font-size", d.css("font-size")), d.css("font-size", ""))
            })
        }
        ...
        this.$element.find("font").each(function (c, e) {
            ...
            a(e).replaceWith(f), f.find("span").each(g)
        }), this.restoreSelectionByMarkers(), this.repositionEditor(), void 0 === e && (e = [d]), this.callback(c, e)
    }
}(jQuery), function (a) {
    a.Editable.prototype._events = {}, a.Editable.prototype.addListener = function (a, b) {
        ...
        if (c)for (var d = 0, e = c.length; e > d; d++)c[d].apply(this, b)
    }
}(jQuery), function (a) {
    a.Editable.prototype.isActive = function (a, b) {
        switch (a) {
            case"fontFamily":
    ...
    a.Editable.prototype.text = function () {
        ...
        if (b.rangeCount) {
            ...
            1 != c.nodeType && (c = c.parentNode), a(c).children().length > 0 && a(a(c).children()[0]).text() == this.text() && (c = a(c).children()[0]);
            for (var d = c; "BODY" != d.tagName;) {
                if (d == this.$element.get(0))return c;
                d = a(d).parent()[0]
            }
        }
        ...
        if (b == c && "TR" == b.tagName) {
            var d = b.childNodes, e = a.startOffset;
            if (d.length > e && e >= 0) {
                var f = d[e];
        ...
        if (!this.selectionDisabled) {
            ...
            c.length > 0 && (b = this.getSelection(), this.mobile() ? this.$element.is(":focus") || this.$element.focus() : this.focus(), this.clearSelection());
            for (var d = 0; d < c.length; d++) {
                var e = a(c[d]).data("id"), f = c[d], g = this.$element.find('.f-marker[data-type="false"][data-id="' + e + '"]');
                if (g.length > 0) {
                    g = g[0];
                    try {
            ...
            c.length > 0 && (this.editableDisabled || this.isHTML || this.options.editInPopup || this.$element.attr("contenteditable", !0), this.removeMarkers())
        }
        ...
        try {
            var e = b.cloneRange();
            e.collapse(c), e.insertNode(a('<span class="f-marker" data-fr-verified="true" data-id="' + d + '" data-type="' + c + '">', document)[0]), e.detach()
        } catch (f) {
        }
    ...
    a.Editable.image_commands = {floatImageLeft:{title:"Float Left", icon:{type:"font", value:"fa fa-align-left"}}, floatImageNone:{title:"Float None", icon:{type:"font", value:"fa fa-align-justify"}}, floatImageRight:{title:"Float Right", icon:{type:"font", value:"fa fa-align-right"}}, linkImage:{title:"Insert Link", icon:{type:"font", value:"fa fa-link"}}, replaceImage:{title:"Replace Image", icon:{type:"font", value:"fa fa-exchange"}}, removeImage:{title:"Remove Image", icon:{type:"font", value:"fa fa-trash-o"}}}, a.Editable.DEFAULTS = a.extend(a.Editable.DEFAULTS, {imageButtons:["floatImageLeft", "floatImageNone", "floatImageRight", "linkImage", "replaceImage", "removeImage"], imageDeleteURL:null, imageDeleteParams:{}, imageMove:!0, imageResize:!0, imageLink:!0, imageUpload:!0, imageUploadParams:{}, imageUploadParam:"file", imageUploadToS3:!1, imageUploadURL:"http://i.froala.com/upload", imagesLoadURL:"http://i.froala.com/images", imagesLoadParams:{}, maxImageSize:10485760, textNearImage:!0}), a.Editable.prototype.hideImageEditorPopup = function () {
        ...
        var b = '<div class="froala-popup froala-image-popup" style="display: none;"><h4><span data-text="true">Insert image</span><i title="Cancel" class="fa fa-times" id="f-image-close-' + this._id + '"></i></h4>';
        return b += '<div id="f-image-list-' + this._id + '">', this.options.imageUpload && (b += '<div class="f-popup-line drop-upload">', b += '<div class="f-upload" id="f-upload-div-' + this._id + '"><strong data-text="true">Drop Image</strong><br>(<span data-text="true">or click</span>)<form target="frame-' + this._id + '" enctype="multipart/form-data" encoding="multipart/form-data" action="' + this.options.imageUploadURL + '" method="post" id="f-upload-form-' + this._id + '"><input id="f-file-upload-' + this._id + '" type="file" name="' + this.options.imageUploadParam + '" accept="image*/
/*"></form></div>', this.browser.msie && a.Editable.getIEversion() <= 9 && (b += '<iframe id="frame-' + this._id + '" name="frame-' + this._id + '" src="javascript:false;" style="width:0; height:0; border:0px solid #FFF; position: fixed; z-index: -1;" data-loaded="true"></iframe>'), b += "</div>"), this.options.imageLink && (b += '<div class="f-popup-line"><label><span data-text="true">Enter URL</span>: </label><input id="f-image-url-' + this._id + '" type="text" placeholder="http://example.com"><button class="f-browse" id="f-browser-' + this._id + '"><i class="fa fa-search"></i></button><button data-text="true" class="f-ok" id="f-image-ok-' + this._id + '">OK</button></div>'), b += "</div>", b += '<p class="f-progress" id="f-progress-' + this._id + '"><span></span></p>', b += "</div>"
        ...
        if (this.options.imageDeleteURL) {
            ...
            c.info = b.data("info"), c.src = b.attr("src"), a.ajax({type:"POST", url:this.options.imageDeleteURL, data:c, crossDomain:this.options.crossDomain, xhrFields:{withCredentials:this.options.withCredentials}, headers:this.options.headers}).done(a.proxy(function (a) {
                b.parent().parent().hasClass("f-image-list") ? b.parent().remove() : b.parent().removeClass("f-img-deleting"), this.callback("imageDeleteSuccess", [a], !1)
            }, this)).fail(a.proxy(function () {
                b.parent().removeClass("f-img-deleting"), this.callback("imageDeleteError", ["Error during image delete."], !1)
            }, this))
        } else b.parent().removeClass("f-img-deleting"), this.callback("imageDeleteError", ["Missing imageDeleteURL option."], !1)
        ...
        var b = this, c = a('<span data-fr-verified="true">').addClass("f-img-handle").on({movestart:function (c) {
            ...
            d.hasClass("f-h-ne") || d.hasClass("f-h-se") ? f.attr("width", g + e) : f.attr("width", g - e), b.callback("imageResize", [], !1)
        }, moveend:function () {
            a(this).removeAttr("data-start-x"), a(this).removeAttr("data-start-y"), b.$element.removeClass("f-non-selectable"), b.isImage || b.$element.attr("contenteditable", !0), b.callback("imageResizeEnd"), a(this).trigger("mouseup")
        }});
        return c
    ...
    }, a.Editable.prototype.initImageResizer = function () {
        ...
        document.addEventListener && document.addEventListener("drop", a.proxy(function () {
            ...
            b.isResizing() || (b.imageHTML = b.getHTML(), (!b.options.imageMove || b.browser.msie) && b.$element.attr("contenteditable", !1))
        }), this.$element.on("mouseup", "img", function () {
            b.isResizing() || b.options.imageMove || b.isImage || b.isHTML || b.$element.attr("contenteditable", !0)
            ...
            if (!b.isResizing()) {
                ...
                a(this).removeClass("fr-fin fr-fir fr-fil");
                var f = b.imageHandle();
        ...
        this.addImageClass(a, "fr-fil"), this.isImage && this.$element.css("float", "left"), this.saveUndoStep(), this.callback("floatImageLeft"), a.find("img").click()
    }, a.Editable.prototype.floatImageNone = function (a) {
        this.addImageClass(a, "fr-fin"), this.isImage || (a.parent().get(0) == this.$element.get(0) ? a.wrap('<div style="text-align: center;"></div>') : a.parents(".f-img-wrap:first").css("text-align", "center")), this.isImage && this.$element.css("float", "none"), this.saveUndoStep(), this.callback("floatImageNone"), a.find("img").click()
    }, a.Editable.prototype.floatImageRight = function (a) {
        this.addImageClass(a, "fr-fir"), this.isImage && this.$element.css("float", "right"), this.saveUndoStep(), this.callback("floatImageRight"), a.find("img").click()
        ...
        a.Editable.LANGS[this.options.language] && (d = a.Editable.LANGS[this.options.language].translation[d]), confirm(d) ? this.callback("beforeRemoveImage", [a(c)], !1) && (b.parents(".f-img-wrap").length ? b.parents(".f-img-wrap").remove() : b.remove(), this.refreshImageList(!0), this.hide(), this.saveUndoStep(), this.wrapText(), this.callback("afterRemoveImage", [a(c)]), this.focus(), this.imageMode = !1) : b.find("img").click()
    ...
    }, a.Editable.prototype.addImageWrapper = function () {
        ...
        b.$image_wrapper.on("dragover", "#f-upload-div-" + this._id, function () {
            ...
            a(this).removeClass("f-hover"), c.preventDefault(), c.stopPropagation(), b.uploadFile(c.originalEvent.dataTransfer.files)
        })
        ...
        return d.onerror = a.proxy(function () {
            ...
            a.attr("src", b), this.hide(), this.hideImageLoader(), this.$image_editor.show(), this.saveUndoStep(), this.callback("replaceImage", [a.get(0)])
        }, this), d.src = b, !1) : (d.onload = a.proxy(function () {
            this.insertLoadedImage(b, c)
        }, this), void(d.src = b))
    }, a.Editable.prototype.insertLoadedImage = function (b) {
        this.restoreSelection(), this.focus(), this.callback("imageLoaded", [b], !1);
        var c = '<img class="fr-fin" alt="Image title" src="' + b + '" width="' + this.options.defaultImageWidth + '">', d = this.getSelectionElements()[0], e = this.getRange(), f = !this.browser.msie && a.Editable.getIEversion() > 8 ? a(e.startContainer) : null;
        f && f.hasClass("f-img-wrap") ? (1 === e.startOffset ? (f.after('<p><span class="f-marker" data-type="true" data-id="0"></span><br/><span class="f-marker" data-type="false" data-id="0"></span></p>'), this.restoreSelectionByMarkers(), this.getSelection().collapseToStart()) : 0 === e.startOffset && (f.before('<p><span class="f-marker" data-type="true" data-id="0"></span><br/><span class="f-marker" data-type="false" data-id="0"></span></p>'), this.restoreSelectionByMarkers(), this.getSelection().collapseToStart()), this.insertHTML(c)) : this.getSelectionTextInfo(d).atStart && d != this.$element.get(0) && "TD" != d.tagName && "TH" != d.tagName && "LI" != d.tagName ? a(d).before("<p>" + c + "</p>") : this.insertHTML(c), this.$element.find("img").each(function (a, b) {
            b.oncontrolselect = function () {
                return!1
            }
        }), this.hide(), this.hideImageLoader(), this.saveUndoStep(), this.focus(), this.wrapText(), this.callback("insertImage", [b])
        ...
        1 == a ? b = "Bad link." : 2 == a ? b = "No link in upload response." : 3 == a ? b = "Error during file upload." : 4 == a ? b = "Parsing response failed." : 5 == a ? b = "Image too large." : 6 == a ? b = "Invalid image type." : 7 == a && (b = "Image can be uploaded only to same domain in IE 8 and IE 9."), this.callback("imageError", {code:a, message:b}, !1), this.hideImageLoader()
    }, a.Editable.prototype.uploadFile = function (b) {
        if (!this.callback("beforeFileUpload", [b], !1))return!1;
        if (void 0 !== b && b.length > 0) {
            ...
            if (c) {
                ...
                }, this), e.send(c), this.$image_wrapper.find("#f-image-list-" + this._id).hide(), this.$progress_bar.show(), this.showInsertImage()
            }
        }
        ...
        }, this)), this.$element.find("span.f-img-editor").length && (this.$element.find("span.f-img-editor").remove(), this.$element.parents("span.f-img-editor").remove()), this.$element.removeClass("f-non-selectable"), this.editableDisabled || this.isHTML || this.$element.attr("contenteditable", !0), this.$image_editor && this.$image_editor.hide()
        ...
        if (!this.isLink && !this.options.editInPopup) {
            ...
            }), void 0 === b)for (var f = 0; f < this.imageList.length; f++)c.indexOf(this.imageList[f].attr("src")) < 0 && this.callback("afterRemoveImage", [this.imageList[f]], !1);
            this.imageList = d
        }
    }
}(jQuery), function (a) {
    a.Editable.prototype.showLinkWrapper = function () {
        this.$link_wrapper && (this.$link_wrapper.show(), this.$link_wrapper.trigger("hideLinkList"), this.$link_wrapper.trigger("hideLinkClassList"), setTimeout(a.proxy(function () {
        ...
        var b = this, c = function (a) {
            ...
            }, this)), b.showByCoordinates(a(this).offset().left + a(this).outerWidth() / 2, a(this).offset().top + (parseInt(a(this).css("padding-top")) || 0) + a(this).height()), b.$link_wrapper.find("input.f-lu").focus(), b.closeImageMode(), b.showInsertLink()
        };
        this.isLink ? this.iOS() ? (this.$element.on("click", c), this.$element.on("touchend", d)) : this.$element.on("click", d) : this.iOS() ? (this.$element.on("click", "a", c), this.$element.on("touchend", "a", d)) : this.$element.on("click", "a", d)
    }, a.Editable.prototype.writeLink = function (b, c, d, e, f) {
        this.options.noFollow && (f = !0), this.options.alwaysBlank && (e = !0);
        var g = "", h = "";
        if (f === !0 && /^https?:\/\//.test(b) && (g = 'rel="nofollow"'), e === !0 && (h = 'target="_blank"'), b = this.sanitizeURL(b), this.imageMode) {
            if ("" !== b) {
                if ("A" != this.$element.find(".f-img-editor").parent().get(0).tagName)this.$element.find(".f-img-editor").wrap('<a data-fr-link="true" href="' + b + '" ' + h + " " + g + "></a>"); else {
                    var i = this.$element.find(".f-img-editor").parent();
            ...
            } else"A" == this.$element.find(".f-img-editor").parent().get(0).tagName && a(this.$element.find(".f-img-editor").get(0)).unwrap(), this.callback("removeImageLink");
            this.saveUndoStep(), this.showImageEditor(), this.$element.find(".f-img-editor").find("img").click(), this.link = !1
        } else {
            if (this.isLink ? "" === c && (c = this.$element.text()) : (this.restoreSelection(), document.execCommand("unlink", !1, b), this.saveSelectionByMarkers(), this.$element.find('span[data-fr-link="true"]').each(function (b, c) {
                a(c).replaceWith(a(c).html())
            }), this.restoreSelectionByMarkers()), "" !== b) {
                var j;
                this.isLink ? (this.$element.text(c), j = [this.$element.attr("href", b).get(0)]) : (document.execCommand("createLink", !1, b), j = this.getSelectionLinks());
                for (var k = 0; k < j.length; k++)e === !0 ? a(j[k]).attr("target", "_blank") : a(j[k]).removeAttr("target"), f === !0 && /^https?:\/\//.test(b) ? a(j[k]).attr("rel", "nofollow") : a(j[k]).removeAttr("rel"), a(j[k]).data("fr-link", !0), a(j[k]).removeClass(Object.keys(this.options.linkClasses).join(" ")), a(j[k]).addClass(d);
                this.$element.find("a:empty").remove(), this.callback("insertLink", [b])
            } else this.isLink || this.$element.find("a:empty").remove(), this.callback("removeLink");
        ...
        var b = this;
        this.addListener("hidePopups", this.hideLinkWrapper), this.isLink && this.options.linkText && this.$link_wrapper.on("mouseup keydown", "input#f-lt-" + this._id, a.proxy(function (a) {
            ...
            a.stopPropagation()
        }), this.$link_wrapper.on("touchend", "button#f-ok-" + this._id,
            function (a) {
                a.stopPropagation()
        ...
        }, this)), this.options.linkList.length && (this.$link_wrapper.on("click touch", "li.f-choose-link",
            function () {
            ...
            a.stopPropagation()
        }), this.$link_wrapper.on("click", "button#f-browse-links-" + this._id,
            function (c) {
                c.stopPropagation();
            ...
            a.stopPropagation(), this.$link_wrapper.trigger("hideLinkList"), this.$link_wrapper.trigger("hideLinkClassList")
        }, this)), this.$link_wrapper.on("click touch", "li.f-choose-link-class",
            function () {
            ...
            a.stopPropagation()
        }), this.$link_wrapper.on("click", "button#f-links-class-" + this._id,
            function (c) {
    ...
    a.Editable.prototype.browserFixes = function () {
        this.preBlockquoteEnter(), this.liEnterSafari(), this.fixBadSpan()
        ...
        this.isImage || this.isLink || this.options.editInPopup || this.$element.on("keydown", a.proxy(function (b) {
            ...
            if (13 == c && "" === this.text() && d.indexOf(e.tagName) >= 0)if (this.getSelectionTextInfo(e).atEnd && !b.shiftKey) {
                b.preventDefault();
                var f = a("<p><br></p>");
        ...
        this.browser.safari && (this.isImage || this.isLink || this.options.editInPopup || this.$element.on("keyup", a.proxy(function (b) {
            var c = b.which;
            if (13 == c && "" === this.text() && !b.shiftKey) {
                var d = this.getSelectionElement();
                if (a(d).parents("li").length > 0) {
        ...
        this.$element.on("DOMNodeInserted", a.proxy(function (b) {
            if ("SPAN" != b.target.tagName || a(b.target).attr("data-fr-verified") || this.no_verify || (a(b.target).before(a(b.target).contents()), a(b.target).remove()), "BR" == b.target.tagName) {
                var c = a(b.target).parent();
                "LI" == c.get(0).tagName && c.find(a.Editable.VALID_NODES.join(",")).length > 0 ? a(b.target).remove() : "LI" == c.get(0).tagName && 0 === c.find(a.Editable.VALID_NODES.join(",")).length && "" === c.text() && 0 === c.find("img").length && 1 === c.parents("ul, ol").find("li").length && c.remove()
            }
        }, this))
    }
}(jQuery), function (a) {
    ...
    a.Editable.TAG_ORDER = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div", "a", "strong", "em", "strike", "u", "span", "iframe"], a.Editable.SEPARATE = ["th", "td", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div"], a.Editable.prototype.tagKey = function (a) {
        ...
        for (var c, d, e, f, g = 0, h = 0, i = [], j = "", k = [], l = {}, m = {}, n = 0; n < b.length; n++)if (c = b.charAt(n), "<" == c) {
            ...
            if (-1 !== o) {
                ...
                var p = this.isClosingTag(d), q = null, r = null, s = null, t = null, u = null, v = d.replace(/^<[\S\s]* style=("[^"]+"|'[^']+')[\S\s]*>$/gi, "$1");
                if (v != d && (v = v.substring(1, v.length - 1), q = v.replace(/^[\S\s]*font-size: *([^;]+)[\S\s]*$/gi, "$1"), q == v && (q = null), r = v.replace(/^[\S\s]*font-family: *([^;]+)[\S\s]*$/gi, "$1"), r == v && (r = null), s = v.replace(/.*(;|^) *color: *([^;]+)[\S\s]*$/gi, "$2"), s == v && (s = null), t = v.replace(/^[\S\s]*background-color: *([^;]+)[\S\s]*$/gi, "$1"), t == v && (t = null)), u = d.match(/([\w\-]*)=("[^<>"]*"|'[^<>']*'|\w+)/gi))for (var w = 0; w < u.length; w++)0 === u[w].indexOf("style=") && u.splice(w, 1);
                if (p) {
                    var x = l[f].pop();
                    g != i[x].start || "span" != f && "iframe" != f && "a" != f || (m[g] || (m[g] = []), m[g].push({i:i[x].i, content:i[x].original}), m[g].push({i:h, content:d}))
                } else i.push({type:f, attrs:u, style:{font_size:q, font_family:r, color:s, background_color:t}, start:g, i:h, original:d}), l[f] || (l[f] = []), l[f].push(i.length - 1);
                n = o
            }
        } else {
            j += c, k[g] = {};
        ...
        for (b = "", d = 0; d <= j.length; d++) {
            ...
            if (k[d])for (k[d].sort(this.sortNodes), e = 0; e < k[d].length; e++)c = k[d][e], l[c.end] || (l[c.end] = []), l[c.end].push(c), b += this.openTag(c);
            d != j.length && (b += j[d])
        }
        return b
    }, a.Editable.prototype.cleanify = function (b) {
        var c, d = "p, div, td, th, pre, li, blockquote";
        if (void 0 === b && (b = !0), this.no_verify = !0, this.saveSelectionByMarkers(), c = b ? this.getSelectionElements() : this.$element.find(d), c[0] != this.$element.get(0))for (var e = 0; e < c.length; e++) {
            var f = a(c[e]);
            f.html(this.cleanOutput(f.html()))
        } else 0 === this.$element.find(d).length && this.$element.html(this.cleanOutput(this.$element.html()));
        this.restoreSelectionByMarkers(), this.$element.find("span").attr("data-fr-verified", !0), this.no_verify = !1
    }
}(jQuery);*/
