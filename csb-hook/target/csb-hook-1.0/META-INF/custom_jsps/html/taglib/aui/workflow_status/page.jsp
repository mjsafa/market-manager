...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/taglib/aui/workflow_status/page.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
...
<span class="taglib-workflow-status">
	<c:if test="<%= Validator.isNotNull(id) %>">
		<span style="display: none;" class="workflow-id">
	...
	<c:if test="<%= Validator.isNotNull(version) %>">
		<span style="display: none;" class="workflow-version">
	...
	<span class="<%= showIcon ? "workflow-status workflow-status-icon" : "workflow-status" %>">
		<c:if test="<%= showLabel %>">
			<span style="display: none;" class="workflow-label"><liferay-ui:message key="status" />:</span>
		</c:if>
