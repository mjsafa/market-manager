...
<liferay-util:buffer var="html">
    <liferay-util:include
        ...
        page="/html/taglib/ui/header/page.portal.jsp"
        useCustomPage="<%= false %>"
    />
</liferay-util:buffer>
...
<div class="taglib-header <%= cssClass %>">
	<c:if test="<%= showBackURL && Validator.isNotNull(backURL) %>">
		<span class="header-back-to">
			<a class="btn btn-lg btn-icon-only  red" href="<%= backURL %>" id="<%= namespace %>TabsBack" title="<%= HtmlUtil.escapeAttribute(backLabel) %>">
