...
<aui:form action="<%= updatePreferencesURL%>" method="POST" name="fm">
    <aui:fieldset>
        ...
        <aui:select name="name" >
            <aui:option value="com.liferay.portlet.blogs.model.BlogsEntry#show_subtitle">BLOG: view subtitle</aui:option>
        </aui:select>
        <aui:input name="value" type="text"/>
