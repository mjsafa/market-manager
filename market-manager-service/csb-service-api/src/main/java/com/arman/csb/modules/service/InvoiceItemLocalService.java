...
/**
 * Provides the local service interface for InvoiceItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InvoiceItemLocalServiceUtil
...
public interface InvoiceItemLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link InvoiceItemLocalServiceUtil} to access the invoice item local service. Add custom service methods to {@link com.arman.csb.modules.service.impl.InvoiceItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
