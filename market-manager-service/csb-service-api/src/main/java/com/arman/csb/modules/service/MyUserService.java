...
/**
 * Provides the remote service interface for MyUser. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see MyUserServiceUtil
...
public interface MyUserService extends BaseService, InvokableService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MyUserServiceUtil} to access the my user remote service. Add custom service methods to {@link com.arman.csb.modules.service.impl.MyUserServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
