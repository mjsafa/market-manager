...
public class MyPageLocalServiceImpl extends MyPageLocalServiceBaseImpl {
    ...
    public Map<String, Object> renderPageHTML(long pageId, ThemeDisplay themeDisplay) {
        try {
            ...
            //JsoupUtil.prependValueToProperty(templateDoc.select("*"), "*", "data-ng-include", resourcesBaseUrl, true);
    ...
    private String getContent(long companyId, long repositoryId, String directory, String fileName, String virtualHost) {
        try {
            ...
            String fileDirectory = SITE_ABSOLUTE_PAT + _fileSeparator + FILE_SYSTEM_RELATIVE_PATH + _fileSeparator + companyDomain + _fileSeparator + directory + _fileSeparator + fileName;
