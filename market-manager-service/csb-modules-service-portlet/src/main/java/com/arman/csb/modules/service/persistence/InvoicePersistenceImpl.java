...
import com.arman.csb.modules.NoSuchInvoiceException;
import com.arman.csb.modules.model.Invoice;
import com.arman.csb.modules.model.impl.InvoiceImpl;
import com.arman.csb.modules.model.impl.InvoiceModelImpl;
...
public class InvoicePersistenceImpl extends BasePersistenceImpl<Invoice>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, InvoiceImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, InvoiceImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
            new String[] { String.class.getName() },
            InvoiceModelImpl.UUID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
            new String[] { String.class.getName() });
    private static final String _FINDER_COLUMN_UUID_UUID_1 = "invoice.uuid IS NULL";
    private static final String _FINDER_COLUMN_UUID_UUID_2 = "invoice.uuid = ?";
    private static final String _FINDER_COLUMN_UUID_UUID_3 = "(invoice.uuid IS NULL OR invoice.uuid = '')";
    public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, InvoiceImpl.class,
            FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
            new String[] { String.class.getName(), Long.class.getName() },
            InvoiceModelImpl.UUID_COLUMN_BITMASK |
            InvoiceModelImpl.GROUPID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUUID_G",
            new String[] { String.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "invoice.uuid IS NULL AND ";
    private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "invoice.uuid = ? AND ";
    private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(invoice.uuid IS NULL OR invoice.uuid = '') AND ";
    private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "invoice.groupId = ?";
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, InvoiceImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
        new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            ...
            new String[] { String.class.getName(), Long.class.getName() },
            InvoiceModelImpl.UUID_COLUMN_BITMASK |
            InvoiceModelImpl.COMPANYID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
            new String[] { String.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "invoice.uuid IS NULL AND ";
    private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "invoice.uuid = ? AND ";
    private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(invoice.uuid IS NULL OR invoice.uuid = '') AND ";
    private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "invoice.companyId = ?";
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, InvoiceImpl.class,
    ...
    public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUserId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_USERID_USERID_2 = "invoice.userId = ?";
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CUSTOMERID =
        new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            ...
            new String[] { Long.class.getName() },
            InvoiceModelImpl.CUSTOMERID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_CUSTOMERID = new FinderPath(InvoiceModelImpl.ENTITY_CACHE_ENABLED,
            InvoiceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCustomerId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_CUSTOMERID_CUSTOMERID_2 = "invoice.customerId = ?";
     ...
     */
    @Override
    public List<Invoice> findByUuid(String uuid) throws SystemException {
     ...
     */
    @Override
    public List<Invoice> findByUuid(String uuid, int start, int end)
    ...
    public List<Invoice> findByUuid(String uuid, int start, int end,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (Invoice invoice : list) {
                if (!Validator.equals(uuid, invoice.getUuid())) {
                    list = null;
        ...
        if (list == null) {
            ...
            if (orderByComparator != null) {
             ...
             if (pagination) {
                query.append(InvoiceModelImpl.ORDER_BY_JPQL);
            }
     ...
     */
    @Override
    public Invoice findByUuid_First(String uuid,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUuid_First(uuid, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUuid_First(String uuid,
        OrderByComparator orderByComparator) throws SystemException {
        List<Invoice> list = findByUuid(uuid, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Invoice findByUuid_Last(String uuid,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUuid_Last(uuid, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUuid_Last(String uuid,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Invoice> list = findByUuid(uuid, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Invoice[] findByUuid_PrevAndNext(long id, String uuid,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = findByPrimaryKey(id);
        ...
        try {
            ...
            array[0] = getByUuid_PrevAndNext(session, invoice, uuid,
                    orderByComparator, true);

            array[1] = invoice;

            array[2] = getByUuid_PrevAndNext(session, invoice, uuid,
    ...
    protected Invoice getByUuid_PrevAndNext(Session session, Invoice invoice,
    ...
    public void removeByUuid(String uuid) throws SystemException {
        for (Invoice invoice : findByUuid(uuid, QueryUtil.ALL_POS,
     ...
     */
    @Override
    public Invoice findByUUID_G(String uuid, long groupId)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUUID_G(uuid, groupId);
     ...
     */
    @Override
    public Invoice fetchByUUID_G(String uuid, long groupId)
        throws SystemException {
            ...
            try {
                ...
                if (list.isEmpty()) {
                    ...
                    if ((invoice.getUuid() == null) ||
                            !invoice.getUuid().equals(uuid) ||
                            (invoice.getGroupId() != groupId)) {
                        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
                            finderArgs, invoice);
                    }
                }
     ...
     */
    @Override
    public Invoice removeByUUID_G(String uuid, long groupId)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = findByUUID_G(uuid, groupId);
     ...
     */
    @Override
    public List<Invoice> findByUuid_C(String uuid, long companyId)
        throws SystemException {
     ...
     */
    @Override
    public List<Invoice> findByUuid_C(String uuid, long companyId, int start,
     ...
     */
    @Override
    public Invoice findByUuid_C_First(String uuid, long companyId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUuid_C_First(uuid, companyId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUuid_C_First(String uuid, long companyId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Invoice> list = findByUuid_C(uuid, companyId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public Invoice findByUuid_C_Last(String uuid, long companyId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUuid_C_Last(String uuid, long companyId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Invoice> list = findByUuid_C(uuid, companyId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Invoice[] findByUuid_C_PrevAndNext(long id, String uuid,
        ...
        try {
            ...
            array[0] = getByUuid_C_PrevAndNext(session, invoice, uuid,
                    companyId, orderByComparator, true);

            array[1] = invoice;

            array[2] = getByUuid_C_PrevAndNext(session, invoice, uuid,
    ...
    protected Invoice getByUuid_C_PrevAndNext(Session session, Invoice invoice,
    ...
    public void removeByUuid_C(String uuid, long companyId)
        throws SystemException {
        for (Invoice invoice : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(invoice);
        }
    }
     ...
     */
    @Override
    public List<Invoice> findByUserId(long userId) throws SystemException {
     ...
     */
    @Override
    public List<Invoice> findByUserId(long userId, int start, int end)
        throws SystemException {
     ...
     */
    @Override
    public Invoice findByUserId_First(long userId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUserId_First(userId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUserId_First(long userId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Invoice> list = findByUserId(userId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Invoice findByUserId_Last(long userId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByUserId_Last(userId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByUserId_Last(long userId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Invoice> list = findByUserId(userId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Invoice[] findByUserId_PrevAndNext(long id, long userId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = findByPrimaryKey(id);
        ...
        try {
            ...
            array[0] = getByUserId_PrevAndNext(session, invoice, userId,
                    orderByComparator, true);

            array[1] = invoice;

            array[2] = getByUserId_PrevAndNext(session, invoice, userId,
                    orderByComparator, false);
    ...
    protected Invoice getByUserId_PrevAndNext(Session session, Invoice invoice,
    ...
    public void removeByUserId(long userId) throws SystemException {
        for (Invoice invoice : findByUserId(userId, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(invoice);
        }
    }
     ...
     */
    @Override
    public List<Invoice> findByCustomerId(long customerId, int start, int end)
        throws SystemException {
     ...
     */
    @Override
    public Invoice findByCustomerId_First(long customerId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByCustomerId_First(customerId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByCustomerId_First(long customerId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Invoice> list = findByCustomerId(customerId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public Invoice findByCustomerId_Last(long customerId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = fetchByCustomerId_Last(customerId, orderByComparator);
     ...
     */
    @Override
    public Invoice fetchByCustomerId_Last(long customerId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Invoice> list = findByCustomerId(customerId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Invoice[] findByCustomerId_PrevAndNext(long id, long customerId,
        OrderByComparator orderByComparator)
        throws NoSuchInvoiceException, SystemException {
        Invoice invoice = findByPrimaryKey(id);
        ...
        try {
            ...
            array[0] = getByCustomerId_PrevAndNext(session, invoice,
                    customerId, orderByComparator, true);

            array[1] = invoice;

            array[2] = getByCustomerId_PrevAndNext(session, invoice,
    ...
    protected Invoice getByCustomerId_PrevAndNext(Session session,
        Invoice invoice, long customerId, OrderByComparator orderByComparator,
        boolean previous) {
        StringBundler query = null;
    ...
    public void removeByCustomerId(long customerId) throws SystemException {
        for (Invoice invoice : findByCustomerId(customerId, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(invoice);
        }
    }
    ...
    public void cacheResult(Invoice invoice) {
        ...
        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
            new Object[] { invoice.getUuid(), invoice.getGroupId() }, invoice);
    ...
    public void clearCache(Invoice invoice) {
        ...
        clearUniqueFindersCache(invoice);
    }
    ...
    protected void cacheUniqueFindersCache(Invoice invoice) {
        if (invoice.isNew()) {
            Object[] args = new Object[] { invoice.getUuid(), invoice.getGroupId() };

            FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_UUID_G, args,
                Long.valueOf(1));
            FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G, args, invoice);
        } else {
            ...
            if ((invoiceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        invoice.getUuid(), invoice.getGroupId()
                    };
    ...
    protected void clearUniqueFindersCache(Invoice invoice) {
        InvoiceModelImpl invoiceModelImpl = (InvoiceModelImpl) invoice;
        ...
        if ((invoiceModelImpl.getColumnBitmask() &
                FINDER_PATH_FETCH_BY_UUID_G.getColumnBitmask()) != 0) {
            args = new Object[] {
                    invoiceModelImpl.getOriginalUuid(),
                    invoiceModelImpl.getOriginalGroupId()
                };
    ...
    @Override
    public Invoice updateImpl(com.arman.csb.modules.model.Invoice invoice)
        throws SystemException {
        invoice = toUnwrappedModel(invoice);
        ...
        if (Validator.isNull(invoice.getUuid())) {
            String uuid = PortalUUIDUtil.generate();
        ...
        if (isNew || !InvoiceModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((invoiceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] { invoiceModelImpl.getOriginalUuid() };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
                    args);

                args = new Object[] { invoiceModelImpl.getUuid() };
            ...
            if ((invoiceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        invoiceModelImpl.getOriginalUuid(),
                        invoiceModelImpl.getOriginalCompanyId()
                    };
                ...
                args = new Object[] {
                        invoiceModelImpl.getUuid(),
                        invoiceModelImpl.getCompanyId()
                    };
            ...
            if ((invoiceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        invoiceModelImpl.getOriginalUserId()
                    };
                ...
                args = new Object[] { invoiceModelImpl.getUserId() };
            ...
            if ((invoiceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        invoiceModelImpl.getOriginalCustomerId()
                    };
                ...
                args = new Object[] { invoiceModelImpl.getCustomerId() };
        ...
        clearUniqueFindersCache(invoice);
        cacheUniqueFindersCache(invoice);
    ...
    protected Invoice toUnwrappedModel(Invoice invoice) {
        ...
        invoiceImpl.setUuid(invoice.getUuid());
        invoiceImpl.setId(invoice.getId());
        invoiceImpl.setGroupId(invoice.getGroupId());
        invoiceImpl.setCompanyId(invoice.getCompanyId());
        invoiceImpl.setUserId(invoice.getUserId());
        invoiceImpl.setUserName(invoice.getUserName());
        invoiceImpl.setCreateDate(invoice.getCreateDate());
        invoiceImpl.setModifiedDate(invoice.getModifiedDate());
        invoiceImpl.setCustomerId(invoice.getCustomerId());
        invoiceImpl.setAddress(invoice.getAddress());
     ...
     */
    @Override
    public Invoice findByPrimaryKey(long id)
        throws NoSuchInvoiceException, SystemException {
     ...
     */
    @Override
    public Invoice fetchByPrimaryKey(long id) throws SystemException {
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.arman.csb.modules.model.Invoice")));
