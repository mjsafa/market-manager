...
import com.arman.csb.modules.service.InstanceLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arman.csb.modules.service.impl.InstanceLocalServiceImpl}.
 * </p>
 *
...
public abstract class InstanceLocalServiceBaseImpl extends BaseLocalServiceImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arman.csb.modules.service.InstanceLocalServiceUtil} to access the instance local service.
     */
    ...
    public Instance createInstance(long id) {
        return instancePersistence.create(id);
    }
    ...
    @Override
    public Instance deleteInstance(long id)
        throws PortalException, SystemException {
        return instancePersistence.remove(id);
    }
    ...
    @Override
    public Instance fetchInstance(long id) throws SystemException {
        return instancePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Instance fetchInstanceByUuidAndCompanyId(String uuid, long companyId)
        throws SystemException {
        return instancePersistence.fetchByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public Instance fetchInstanceByUuidAndGroupId(String uuid, long groupId)
        throws SystemException {
        return instancePersistence.fetchByUUID_G(uuid, groupId);
    }
    ...
    public Instance getInstance(long id)
        throws PortalException, SystemException {
        return instancePersistence.findByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Instance getInstanceByUuidAndCompanyId(String uuid, long companyId)
        throws PortalException, SystemException {
        return instancePersistence.findByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public Instance getInstanceByUuidAndGroupId(String uuid, long groupId)
        throws PortalException, SystemException {
        return instancePersistence.findByUUID_G(uuid, groupId);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arman.csb.modules.model.Instance",
