...
public class InstanceLocalServiceClpInvoker {
    ...
    public InstanceLocalServiceClpInvoker() {
        ...
        _methodParameterTypes0 = new String[] {
                "com.arman.csb.modules.model.Instance"
            };
        ...
        _methodName11 = "fetchInstanceByUuidAndCompanyId";

        _methodParameterTypes11 = new String[] { "java.lang.String", "long" };

        _methodName12 = "fetchInstanceByUuidAndGroupId";

        _methodParameterTypes12 = new String[] { "java.lang.String", "long" };

        _methodName13 = "getInstance";
        ...
        _methodName15 = "getInstanceByUuidAndCompanyId";

        _methodParameterTypes15 = new String[] { "java.lang.String", "long" };

        _methodName16 = "getInstanceByUuidAndGroupId";

        _methodParameterTypes16 = new String[] { "java.lang.String", "long" };

        _methodName17 = "getInstances";

        _methodParameterTypes17 = new String[] { "int", "int" };

        _methodName18 = "getInstancesCount";

        _methodParameterTypes18 = new String[] {  };

        _methodName19 = "updateInstance";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return InstanceLocalServiceUtil.addInstance((com.arman.csb.modules.model.Instance) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return InstanceLocalServiceUtil.deleteInstance((com.arman.csb.modules.model.Instance) arguments[0]);
        }
        ...
        if (_methodName11.equals(name) &&
            ...
            return InstanceLocalServiceUtil.fetchInstanceByUuidAndCompanyId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }

        if (_methodName12.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes12, parameterTypes)) {
            return InstanceLocalServiceUtil.fetchInstanceByUuidAndGroupId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return InstanceLocalServiceUtil.getInstanceByUuidAndCompanyId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }

        if (_methodName16.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes16, parameterTypes)) {
            return InstanceLocalServiceUtil.getInstanceByUuidAndGroupId((java.lang.String) arguments[0],
                ((Long) arguments[1]).longValue());
        }
        ...
        if (_methodName19.equals(name) &&
            ...
            return InstanceLocalServiceUtil.updateInstance((com.arman.csb.modules.model.Instance) arguments[0]);
        }
