...
import com.arman.csb.modules.service.PaymentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arman.csb.modules.service.impl.PaymentLocalServiceImpl}.
 * </p>
 *
...
public abstract class PaymentLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PaymentLocalService, IdentifiableBean {
    ...
    private PaymentLocalServiceClpInvoker _clpInvoker = new PaymentLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arman.csb.modules.service.PaymentLocalServiceUtil} to access the payment local service.
     */
    ...
    public Payment createPayment(long id) {
        return paymentPersistence.create(id);
    }
    ...
    public Payment deletePayment(long id)
        ...
        return paymentPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Payment deletePayment(Payment payment) throws SystemException {
    ...
    @Override
    public Payment fetchPayment(long id) throws SystemException {
        return paymentPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Payment fetchPaymentByUuidAndCompanyId(String uuid, long companyId)
        throws SystemException {
        return paymentPersistence.fetchByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public Payment getPayment(long id) throws PortalException, SystemException {
        return paymentPersistence.findByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Payment getPaymentByUuidAndCompanyId(String uuid, long companyId)
        throws PortalException, SystemException {
        return paymentPersistence.findByUuid_C_First(uuid, companyId, null);
    }
     ...
     */
    @Override
    public int getPaymentsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Payment updatePayment(Payment payment) throws SystemException {
        return paymentPersistence.update(payment);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arman.csb.modules.model.Payment",
            paymentLocalService);
    }
