d3 = function () {
    ...
    function xt() {
        var n = Date.now();
        for (ma = ga; ma;)n >= ma.time && (ma.flush = ma.callback(n - ma.time)), ma = ma.next;
        return n
    }

    function bt() {
        for (var n, t = ga, e = 1 / 0; t;)t.flush ? t = n ? n.next = t.next : ga = t.next : (t.time < e && (e = t.time), t = (n = t).next);
        return pa = n, e
    }
    ...
    function Ft(n) {
        return[Math.atan2(n[1], n[0]), P(n[2])]
    }
    ...
    function Ut() {
        function n(n, t) {
            n *= Jo;
            var e = Math.cos(t *= Jo), o = e * Math.cos(n), a = e * Math.sin(n), c = Math.sin(t), l = u * c - i * a, s = i * o - r * c, f = r * a - u * o, h = Math.sqrt(l * l + s * s + f * f), g = r * o + u * a + i * c, p = h && -F(g) / h, d = Math.atan2(h, g);
    ...
    function ne(n, t, e, r) {
        var u;
        if (null == n)u = e * Bo / 2, r.point(-Bo, u), r.point(0, u), r.point(Bo, u), r.point(Bo, 0), r.point(Bo, -u), r.point(0, -u), r.point(-Bo, -u), r.point(-Bo, 0), r.point(-Bo, u); else if (Math.abs(n[0] - t[0]) > $o) {
    ...
    function ee(n) {
        ...
        function e(n) {
            ...
            return{lineStart:function () {
                ...
                if (!e && (c = o = d) && n.lineStart(), d !== o && (g = r(e, p), (Pt(e, g) || Pt(p, g)) && (p[0] += $o, p[1] += $o, d = t(p[0], p[1]))), d !== o)s = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g; else if (l && e && a ^ d) {
                    var m;
                ...
                !d || e && Pt(e, p) || n.point(p[0], p[1]), e = p, o = d, i = v
            }, lineEnd:function () {
                o && n.lineEnd(), e = null
            }, clean:function () {
                return s | (c && o) << 1
    ...
    function ae(n, t) {
        ...
        return e.invert = function (n, t) {
            var e = o - t;
            return[Math.atan2(n, e) / u, P((i - (n * n + e * e) * u * u) / (2 * u))]
        }, e
    }
    ...
    function Ae(n, t) {
        function e(n, t) {
            ...
            return[Math.atan2(c * i - s * o, a * r - l * u), P(s * i + c * o)]
        }
        ...
        return e.invert = function (n, t) {
            ...
            return[Math.atan2(c * i + l * o, a * r + s * u), P(s * r - a * u)]
        }, e
    }
    ...
    function Ne(n, t) {
        ...
        return function (u, i, o, a) {
            ...
            for (var l, s = u; o > 0 ? s > i : i > s; s -= c)a.point((l = Ft([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], l[1])
        }
    }
    ...
    function Ie(n) {
        function t(t) {
            ...
            for (var c, l = [], s = [], f = -1, h = t.length, g = gt(e), p = gt(r); ++f < h;)u.call(this, c = t[f], f) ? s.push([+g.call(this, c, f), +p.call(this, c, f)]) : s.length && (o(), s = []);
    ...
    function Qe(n, t) {
        if (t.length < 1 || n.length != t.length && n.length != t.length + 2)return Ze(n);
    ...
    function tr(n) {
        if (n.length < 3)return Ze(n);
        var t = 1, e = n.length, r = n[0], u = r[0], i = r[1], o = [u, u, u, (r = n[1])[0]], a = [i, i, i, r[1]], c = [u, ",", i, "L", ir(pc, o), ",", ir(pc, a)];
        for (n.push(n[e - 1]); ++t <= e;)r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), or(c, o, a);
        return n.pop(), c.push("L", r), c.join("")
    }

    function er(n) {
        if (n.length < 4)return Ze(n);
        for (var t, e = [], r = -1, u = n.length, i = [0], o = [0]; ++r < 3;)t = n[r], i.push(t[0]), o.push(t[1]);
        for (e.push(ir(pc, i) + "," + ir(pc, o)), --r; ++r < u;)t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), or(e, i, o);
        return e.join("")
    }

    function rr(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4;)e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [ir(pc, o), ",", ir(pc, a)], --r; ++r < i;)e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), or(t, o, a);
        return t.join("")
    }
    ...
    function cr(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = ar(u, i); ++t < e;)r[t] = (o + (o = ar(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }
    ...
    function br(n, t) {
        var e, r = {}, u = {};
        for (e in n)e in t ? r[e] = Sr(n[e], t[e]) : u[e] = n[e];
    ...
    function wr(n, t) {
        ...
        for (a < t.length && l.push(t.substring(a)), r = 0, i = s.length; (e = mc.exec(n)) && i > r; ++r)if (o = s[r], o.x == e[0]) {
            ...
            s.splice(r, 1), i--, r--
        } else o.x = _r(parseFloat(e[0]), parseFloat(o.x));
    ...
    function Er(n, t) {
        ...
        for (e = 0; a > e; ++e)r.push(Sr(n[e], t[e]));
        for (; i > e; ++e)u[e] = n[e];
        for (; o > e; ++e)u[e] = t[e];
        return function (n) {
    ...
    function Kr(n, t) {
        if (n === t)return n;
        for (var e = Gr(n), r = Gr(t), u = e.pop(), i = r.pop(), o = null; u === i;)o = u, u = e.pop(), i = r.pop();
        return o
    }
    ...
    function ru(n, t, e) {
        var r = 0, u = 0;
        if (n.charge = 0, !n.leaf)for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;)i = o[c], null != i && (ru(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function wu(n, t) {
        var e = n.children;
        if (e && (u = e.length))for (var r, u, i = -1; ++i < u;)t(r = wu(e[i], t), n) > 0 && (n = r);
        return n
    }
    ...
    function Lu(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            if (e.forEach(Hu), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2))for (i = e[2], Ou(r, u, i), t(i), Cu(r, i), r._pack_prev = i, Cu(i, u), u = r._pack_next, o = 3; l > o; o++) {
                Ou(r, u, i = e[o]);
                var p = 0, d = 1, v = 1;
                for (a = u._pack_next; a !== u; a = a._pack_next, d++)if (ju(a, i)) {
                    p = 1;
                    break
                }
                if (1 == p)for (c = r._pack_prev; c !== a._pack_prev && !ju(c, i); c = c._pack_prev, v++);
    ...
    function Pu(n, t, e, r) {
        var u = n.children;
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u)for (var i = -1, o = u.length; ++i < o;)Pu(u[i], t, e, r)
    }
    ...
    function ci(n, t) {
        function e() {
            var e = 0, i = t.length;
            for (u = []; ++e < i;)u[e - 1] = vo.quantile(n, e / i);
            return r
        }
        ...
        return r.domain = function (t) {
            return arguments.length ? (n = t.filter(
                function (n) {
                    return!isNaN(n)
    ...
    function vi(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i;)t = n[u], e = t[0], r = t[1] + jc, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    ...
    function mi(n) {
        function t(t) {
            ...
            for (var h, g, p, d = [], v = [], m = [], y = -1, M = t.length, x = gt(e), b = gt(u), _ = e === r ? function () {
                ...
                return p
            } : gt(i); ++y < M;)o.call(this, h = t[y], y) ? (v.push([g = +x.call(this, h, y), p = +b.call(this, h, y)]), m.push([+_.call(this, h, y), +w.call(this, h, y)])) : v.length && (c(), v = [], m = []);
    ...
    function xi(n) {
        return function () {
            var t = n.apply(this, arguments), e = t[0], r = t[1] + jc;
    ...
    function Ci(n, t, e) {
        ...
        function u(e) {
            return t(e = n(new $c(e - 1)), 1), e
        }

        function i(n, e) {
            return t(n = new $c(+n), e), n
        }
    ...
    function ji(n) {
        function t(t) {
            for (var r, u, i, o = [], a = -1, c = 0; ++a < e;)37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = gl[r = n.charAt(++a)]) && (r = n.charAt(++a)), (i = pl[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)), o.push(r), c = a + 1);
    ...
    function Li(n, t, e, r) {
        for (var u, i, o, a = 0, c = t.length, l = e.length; c > a;) {
            ...
            if (u = t.charCodeAt(a++), 37 === u) {
                if (o = t.charAt(a++), i = dl[o in gl ? t.charAt(a++) : o], !i || (r = i(n, e, r)) < 0)return-1
    ...
    function Ri(n, t, e) {
        ...
        return r ? (n.w = il.get(r[0].toLowerCase()), e + r[0].length) : -1
    }

    function Yi(n, t, e) {
        vl.lastIndex = 0;
        var r = vl.exec(t.substring(e, e + 1));
        return r ? (n.w = +r[0], e + r[0].length) : -1
    }

    function Ii(n, t, e) {
        vl.lastIndex = 0;
        var r = vl.exec(t.substring(e));
    ...
    function Xi(n, t, e) {
        return Li(n, pl.c.toString(), t, e)
    }

    function Bi(n, t, e) {
        return Li(n, pl.x.toString(), t, e)
    }
    ...
    function Wi(n, t, e) {
        vl.lastIndex = 0;
        var r = vl.exec(t.substring(e, e + 4));
        return r ? (n.y = +r[0], e + r[0].length) : -1
    }

    function Ji(n, t, e) {
        vl.lastIndex = 0;
        var r = vl.exec(t.substring(e, e + 2));
    ...
    function no(n, t, e) {
        vl.lastIndex = 0;
        var r = vl.exec(t.substring(e, e + 3));
    ...
    function ao(n, t, e) {
        hl.lastIndex = 0;
        var r = hl.exec(t.substring(e, e + 1));
    ...
    function so(n, t, e) {
        ...
        function u(n, e) {
            var r = n[1] - n[0], u = r / e, i = vo.bisect(Ml, u);
            return i == Ml.length ? [t.year, ti(n.map(function (n) {
                return n / 31536e6
            }), e)[2]] : i ? t[u / Ml[i - 1] < Ml[i] / u ? i - 1 : i] : [wl, ti(n, e)[2]]
        }
        ...
        return r.invert = function (t) {
            ...
            var e = Xu(r.domain()), i = null == n ? u(e, 10) : "number" == typeof n ? u(e, n) : !n.range && [
                {range:n},
                t
            ];
    ...
    vo.bisectLeft = qo.left, vo.bisect = vo.bisectRight = qo.right, vo.shuffle = function (n) {
        ...
        for (var n = -1, e = vo.min(arguments, t), r = new Array(e); ++n < e;)for (var u, i = -1, o = r[n] = new Array(u); ++i < u;)o[i] = arguments[i][n];
        return r
        ...
        for (var t in this)t.charCodeAt(0) === zo && n.call(this, t.substring(1), this[t])
    }});
    var To = "\0", zo = To.charCodeAt(0);
    vo.nest = function () {
        function n(t, a, c) {
        ...
        for (var t in this)t.charCodeAt(0) === zo && n.call(this, t.substring(1))
    ...
    }, Fo = xo[a(xo, "matchesSelector")], Po = function (n, t) {
        return Fo.call(n, t)
    };
    ...
    }, Po = Sizzle.matchesSelector), vo.selection = function () {
        return Io
    };
    ...
    Oo.select = function (n) {
        ...
        var t, e, r = [];
        n = v(n);
        for (var u = -1, i = this.length; ++u < i;)for (var o = this[u], a = -1, c = o.length; ++a < c;)(e = o[a]) && (r.push(t = yo(n.call(e, e.__data__, a, u))), t.parentNode = e);
        return p(r)
    };
    ...
    vo.ns = {prefix:Ro, qualify:function (n) {
        ...
        if (3 > r) {
            ...
            if (2 > r)return bo.getComputedStyle(this.node(), null).getPropertyValue(n);
            e = ""
        }
    ...
    vo.interpolateZoom = function (n, t) {
        ...
        function i() {
            b && b.domain(x.range().map(
                function (n) {
                    return(n - S.x) / S.k
                }).map(x.invert)), w && w.domain(_.range().map(
                function (n) {
                    return(n - S.y) / S.k
                }).map(_.invert))
        }
        ...
        return n.event = function (n) {
            n.each(function () {
                ...
                Fc ? vo.select(this).transition().each("start.zoom",
                    function () {
    ...
    ha.forEach(function (n, t) {
        ...
        return e.parse = function (n, t) {
            ...
            return e.parseRows(n, function (n, e) {
                if (r)return r(n, e - 1);
                var u = new Function("d", "return {" + n.map(
                    function (n, t) {
    ...
    var Ma = ".", xa = ",", ba = [3, 3], _a = "$", wa = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(_t);
    ...
    if (ba) {
        var Aa = ba.length;
        ka = function (n) {
            for (var t = n.length, e = [], r = 0, u = ba[0]; t > 0 && u > 0;)e.push(n.substring(t -= u, t + u)), u = ba[r = (r + 1) % Aa];
    ...
    vo.geo.bounds = function () {
        ...
        ja = La = Ha = Fa = Pa = Oa = Ra = Ya = Ia = Ua = Va = 0, vo.geo.stream(n, Za);
        var t = Ia, e = Ua, r = Va, u = t * t + e * e + r * r;
        return Wo > u && (t = Oa, e = Ra, r = Ya, $o > La && (t = Ha, e = Fa, r = Pa), u = t * t + e * e + r * r, Wo > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Go, P(r / Math.sqrt(u)) * Go]
    };
    var ja, La, Ha, Fa, Pa, Oa, Ra, Ya, Ia, Ua, Va, Za = {sphere:c, point:Ot, lineStart:Yt, lineEnd:It, polygonStart:function () {
        Za.lineStart = Ut
    }, polygonEnd:function () {
        Za.lineStart = Yt
    ...
    vo.geo.transform = function (n) {
        ...
        return n.area = function (n) {
            ...
            return Ha = Fa = Pa = Oa = Ra = Ya = Ia = Ua = Va = 0, vo.geo.stream(n, u(rc)), Va ? [Ia / Va, Ua / Va] : Ya ? [Oa / Ya, Ra / Ya] : Pa ? [Ha / Pa, Fa / Pa] : [0 / 0, 0 / 0]
        }, n.bounds = function (n) {
            return Qa = nc = -(Ga = Ka = 1 / 0), vo.geo.stream(n, u(ec)), [
                [Ga, Ka],
                [Qa, nc]
            ]
        ...
        function t() {
            return vo.range(Math.ceil(i / v) * v, u, v).map(h).concat(vo.range(Math.ceil(l / m) * m, c, m).map(g)).concat(vo.range(Math.ceil(r / p) * p, e, p).filter(
                function (n) {
                    return Math.abs(n % v) > $o
                }).map(s)).concat(vo.range(Math.ceil(a / d) * d, o, d).filter(
                function (n) {
    ...
    (vo.geo.azimuthalEquidistant = function () {
        ...
        return oe(Fe)
    }).raw = Fe, (vo.geo.conicEquidistant = function () {
        return oe(Pe)
    }).raw = Pe;
    ...
    (vo.geo.stereographic = function () {
        ...
        return[Math.atan2(O(n), Math.cos(t)), P(Math.sin(t) / R(n))]
    ...
    vo.geom.hull = function (n) {
        function t(n) {
            ...
            if (d === Ue && r === Ve)t = n; else for (i = 0, t = []; m > i; ++i)t.push([+d.call(this, u = n[i], i), +v.call(this, u, i)]);
            ...
            for (p = x.length; y > o; ++o)if (!(M[o].index < 0)) {
                for (; !fr(x[p - 2], x[p - 1], M[o].index, t);)--p;
                x[p++] = M[o].index
            }
            var _ = [];
    ...
    dc.area = function () {
        ...
        for (var t, e, r, u, i, o, a = pr(n), c = -1, l = this.length - pr(this), s = this[l - 1]; ++c < l;) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = -1; ++e < r;)o = t[e], hr(o, s, u) ? (hr(i, s, u) || n.push(gr(i, o, s, u)), n.push(o)) : hr(i, s, u) && n.push(gr(i, o, s, u)), i = o;
            a && n.push(n[0]), s = u
        }
        return n
        ...
        function t(n) {
            ...
            if (c === Ue && l === Ve)t = n; else for (t = new Array(s), o = 0; s > o; ++o)t[o] = [+c.call(this, i = n[o], o), +l.call(this, i, o)];
            if (dr(t, function (n) {
                var t, e, r, u, i, o;
        ...
        return arguments.length ? t(n) : (t.x = function (n) {
            ...
            if (c === Ue && l === Ve)t = n; else for (t = new Array(s), i = 0; s > i; ++i)t[i] = [+c.call(this, u = n[i], i), +l.call(this, u, i)];
            return dr(t, function (t) {
                var e = t.region.l.index, r = t.region.r.index;
                o[e][r] || (o[e][r] = o[r][e] = !0, a.push({source:n[e], target:n[r]}))
            }), a
        }, t.triangles = function (n) {
            if (e === Ue && r === Ve)return vo.geom.delaunay(n);
            for (var t, u = new Array(c), i = gt(e), o = gt(r), a = -1, c = n.length; ++a < c;)(u[a] = [+i.call(this, t = n[a], a), +o.call(this, t, a)]).data = t;
    ...
    vo.interpolateTransform = Br, vo.layout = {}, vo.layout.bundle = function () {
        ...
        var e, r, u, i, o, a = {}, c = vo.dispatch("start", "tick", "end"), l = [1, 1], s = .9, f = _c, h = wc, g = -30, p = .1, d = .8, v = [], m = [];
        return a.tick = function () {
            ...
            if (g)for (ru(t = vo.geom.quadtree(v), r, o), e = -1; ++e < b;)(a = v[e]).fixed || t.visit(n(a));
    ...
    vo.layout.stack = function () {
        ...
        return n.values = function (e) {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : Ec.get(t) || hu, n) : e
        }, n.offset = function (t) {
            return arguments.length ? (r = "function" == typeof t ? t : kc.get(t) || gu, n) : r
        }, n.x = function (t) {
            return arguments.length ? (i = t, n) : i
        }, n.y = function (t) {
    ...
    var Ec = vo.map({"inside-out":function (n) {
    ...
    }, "default":hu}), kc = vo.map({silhouette:function (n) {
    ...
    vo.layout.histogram = function () {
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], l = i._tree.mod, s = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = _u(a), i = bu(i), a && i;)c = bu(c), o = _u(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - l + e(a, i), u > 0 && (qu(Tu(a, n, r), n, u), l += u, s += u), f += a._tree.mod, l += i._tree.mod, h += c._tree.mod, s += o._tree.mod;
        ...
        function n(n, i) {
            ...
            return Pu(a, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / l)), o
        }
    ...
    vo.scale.pow = function () {
        ...
        return vo.scale.ordinal().range(Tc)
    ...
    var Tc = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(ut), zc = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(ut), Cc = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(ut), Dc = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(ut);
    vo.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments), i = e.apply(this, arguments), o = r.apply(this, arguments) + jc, a = u.apply(this, arguments) + jc, c = (o > a && (c = o, o = a, a = c), a - o), l = Bo > c ? "0" : "1", s = Math.cos(o), f = Math.sin(o), h = Math.cos(a), g = Math.sin(a);
            return c >= Lc ? n ? "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "M0," + n + "A" + n + "," + n + " 0 1,0 0," + -n + "A" + n + "," + n + " 0 1,0 0," + n + "Z" : "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "Z" : n ? "M" + i * s + "," + i * f + "A" + i + "," + i + " 0 " + l + ",1 " + i * h + "," + i * g + "L" + n * h + "," + n * g + "A" + n + "," + n + " 0 " + l + ",0 " + n * s + "," + n * f + "Z" : "M" + i * s + "," + i * f + "A" + i + "," + i + " 0 " + l + ",1 " + i * h + "," + i * g + "L0,0" + "Z"
        }
        ...
        return n.innerRadius = function (e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2, i = (r.apply(this, arguments) + u.apply(this, arguments)) / 2 + jc;
            return[Math.cos(i) * n, Math.sin(i) * n]
        }, n
    };
    var jc = -Bo / 2, Lc = 2 * Bo - 1e-6;
    vo.svg.line.radial = function () {
        ...
        function t(n, t, e, r) {
            var u = t.call(n, e, r), i = a.call(n, u, r), o = c.call(n, u, r) + jc, s = l.call(n, u, r) + jc;
        ...
        function n(n, r) {
            return(Hc.get(t.call(this, n, r)) || wi)(e.call(this, n, r))
        }
    ...
    var Hc = vo.map({circle:wi, cross:function (n) {
        var t = Math.sqrt(n / 5) / 2;
        return"M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t + "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t + "V" + t + "H" + -3 * t + "Z"
    }, diamond:function (n) {
        var t = Math.sqrt(n / (2 * Rc)), e = t * Rc;
        return"M0," + -t + "L" + e + ",0" + " 0," + t + " " + -e + ",0" + "Z"
    }, square:function (n) {
        var t = Math.sqrt(n) / 2;
        return"M" + -t + "," + -t + "L" + t + "," + -t + " " + t + "," + t + " " + -t + "," + t + "Z"
    }, "triangle-down":function (n) {
        var t = Math.sqrt(n / Oc), e = t * Oc / 2;
        return"M0," + e + "L" + t + "," + -e + " " + -t + "," + -e + "Z"
    }, "triangle-up":function (n) {
        var t = Math.sqrt(n / Oc), e = t * Oc / 2;
        return"M0," + -e + "L" + t + "," + e + " " + -t + "," + e + "Z"
    }});
    vo.svg.symbolTypes = Hc.keys();
    var Fc, Pc, Oc = Math.sqrt(3), Rc = Math.tan(30 * Jo), Yc = [], Ic = 0;
    Yc.call = Oo.call, Yc.empty = Oo.empty, Yc.node = Oo.node, Yc.size = Oo.size, vo.transition = function (n) {
        return arguments.length ? Fc ? n.transition() : n : Io.transition()
    }, vo.transition.prototype = Yc, Oo.transition = function () {
        for (var n, t, e = Fc || ++Ic, r = [], u = Pc || {time:Date.now(), ease:zr, delay:0, duration:250}, i = -1, o = this.length; ++i < o;) {
            r.push(n = []);
        ...
        if (arguments.length < 2) {
            ...
            Fc = e, N(this, function (t, r, u) {
                Pc = t.__transition__[e], n.call(t, t.__data__, r, u)
            }), Pc = r, Fc = u
        ...
        for (var n, t, e, r, u = this.id, i = ++Ic, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
        ...
        var t, e = vo.scale.linear(), r = Uc, u = 6, i = 6, o = 3, a = [10], c = null;
        return n.scale = function (t) {
            return arguments.length ? (e = t, n) : e
        }, n.orient = function (t) {
            return arguments.length ? (r = t in Vc ? t + "" : Uc, n) : r
        }, n.ticks = function () {
    ...
    var Uc = "bottom", Vc = {top:1, right:1, bottom:1, left:1};
    vo.svg.brush = function () {
        ...
        function u() {
            ...
            if (vo.event.changedTouches ? C.on("touchmove.brush", m).on("touchend.brush", M) : C.on("mousemove.brush", m).on("mouseup.brush", M), E.interrupt().selectAll("*").interrupt(), q)z[0] = s[0] - z[0], z[1] = h[0] - z[1]; else if (k) {
        ...
        var i, o, a = g(n, "brushstart", "brush", "brushend"), c = null, l = null, s = [0, 0], h = [0, 0], p = !0, d = !0, v = Xc[0];
        return n.event = function (n) {
            n.each(function () {
                var n = a.of(this, arguments), t = {x:s, y:h, i:i, j:o}, e = this.__chart__ || t;
                this.__chart__ = t, Fc ? vo.select(this).transition().each("start.brush",
                    function () {
            ...
            return arguments.length ? (c = t, v = Xc[!c << 1 | !l], n) : c
        }, n.y = function (t) {
            return arguments.length ? (l = t, v = Xc[!c << 1 | !l], n) : l
        }, n.clamp = function (t) {
    ...
    var Zc = {n:"ns-resize", e:"ew-resize", s:"ns-resize", w:"ew-resize", nw:"nwse-resize", ne:"nesw-resize", se:"nwse-resize", sw:"nesw-resize"}, Xc = [
        ["n", "e", "s", "w", "nw", "ne", "se", "sw"],
        ["e", "w"],
        ["n", "s"],
        []
    ], Bc = vo.time = {}, $c = Date, Wc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    zi.prototype = {getDate:function () {
        ...
        Jc.setUTCDate.apply(this._, arguments)
    }, setDay:function () {
        Jc.setUTCDay.apply(this._, arguments)
    }, setFullYear:function () {
        Jc.setUTCFullYear.apply(this._, arguments)
    }, setHours:function () {
        Jc.setUTCHours.apply(this._, arguments)
    }, setMilliseconds:function () {
        Jc.setUTCMilliseconds.apply(this._, arguments)
    }, setMinutes:function () {
        Jc.setUTCMinutes.apply(this._, arguments)
    }, setMonth:function () {
        Jc.setUTCMonth.apply(this._, arguments)
    }, setSeconds:function () {
        Jc.setUTCSeconds.apply(this._, arguments)
    }, setTime:function () {
        Jc.setTime.apply(this._, arguments)
    }};
    var Jc = Date.prototype, Gc = "%a %b %e %X %Y", Kc = "%m/%d/%Y", Qc = "%H:%M:%S", nl = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], tl = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], el = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], rl = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    var ul = Hi(nl), il = Fi(nl), ol = Hi(tl), al = Fi(tl), cl = Hi(el), ll = Fi(el), sl = Hi(rl), fl = Fi(rl), hl = /^%/, gl = {"-":"", _:" ", 0:"0"}, pl = {a:function (n) {
        return tl[n.getDay()]
    }, A:function (n) {
        return nl[n.getDay()]
    }, b:function (n) {
        ...
        return el[n.getMonth()]
    }, c:ji(Gc), d:function (n, t) {
    ...
    }, x:ji(Kc), X:ji(Qc), y:function (n, t) {
        return Pi(n.getFullYear() % 100, t, 2)
    }, Y:function (n, t) {
        return Pi(n.getFullYear() % 1e4, t, 4)
    }, Z:oo, "%":function () {
        return"%"
    }}, dl = {a:Oi, A:Ri, b:Vi, B:Zi, c:Xi, d:Qi, e:Qi, H:to, I:to, j:no, L:uo, m:Ki, M:eo, p:io, S:ro, U:Ii, w:Yi, W:Ui, x:Bi, X:$i, y:Ji, Y:Wi, "%":ao}, vl = /^\s*\d+/, ml = vo.map({am:0, pm:1});
    ji.utc = co;
    var yl = co("%Y-%m-%dT%H:%M:%S.%LZ");
    ji.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? lo : yl, lo.parse = function (n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }, lo.toString = yl.toString, Bc.second = Ci(function (n) {
        return new $c(1e3 * Math.floor(n / 1e3))
    }, function (n, t) {
        n.setTime(n.getTime() + 1e3 * Math.floor(t))
    }, function (n) {
        return n.getSeconds()
    }), Bc.seconds = Bc.second.range, Bc.seconds.utc = Bc.second.utc.range, Bc.minute = Ci(function (n) {
        return new $c(6e4 * Math.floor(n / 6e4))
    }, function (n, t) {
        ...
        return new $c(36e5 * (Math.floor(n / 36e5 - t) + t))
    }, function (n, t) {
    ...
    var Ml = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], xl = [
        [Bc.second, 1],
        [Bc.second, 5],
        [Bc.second, 15],
        [Bc.second, 30],
    ...
    xl.year = Bc.year, Bc.scale = function () {
        return so(vo.scale.linear(), xl, _l)
    };
    var wl = {range:function (n, t, e) {
        return vo.range(+n, +t, e).map(fo)
    }}, Sl = xl.map(function (n) {
        return[n[0].utc, n[1]]
    }), El = [
        [co("%Y"), Vt],
        [co("%B"), function (n) {
    ...
    return Sl.year = Bc.year.utc, Bc.scale.utc = function () {
        return so(vo.scale.linear(), Sl, kl)
