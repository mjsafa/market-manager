...
Backbone.Paginator = (function (Backbone, _, $) {
    ...
    Paginator.clientPager = Backbone.Collection.extend({
        ...
        startFrom: function () {
            return (this.currentPage - 1) * this.paginator_ui.perPage;
        },
        endTo: function () {
            return this.currentPage * this.paginator_ui.perPage;
        },
        ...
        _filter: function (models, fields, filter) {
            ...
            if (filter === '' || !_.isString(filter)) {
                ...
                var words = _.map(filter.match(/\w+/ig), function (element) {
    ...
    Paginator.requestPager = Backbone.Collection.extend({
        ...
        parse: function (res) {
            this.totalPages = Math.ceil(res.pop() / this.paginator_ui.perPage);
            return res;
        },
