...
// full month names
Calendar._MN =
    new Array("ژانویه", "فوریه", "مارس", "آوریل", "می", "جون", "جولای", "آگوست", "سپتامبر", "اکتبر", "نوامبر",
        "دسامبر");
...
// short month names
Calendar._JSMN = new Array("فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن",
    "اسفند");
...
Calendar._TT["PREV_YEAR"] = "سال قبل (برای مشاهده منو، دکمه را نگه دارید)";
Calendar._TT["PREV_MONTH"] = "ماه قبل (برای مشاهده منو، دکمه را نگه دارید)";
Calendar._TT["GO_TODAY"] = "رفتن به امروز";
Calendar._TT["NEXT_MONTH"] = "ماه بعد (برای مشاهده منو، دکمه را نگه دارید)";
Calendar._TT["NEXT_YEAR"] = "سال بعد (برای مشاهده منو، دکمه را نگه دارید)";
Calendar._TT["SEL_DATE"] = "انتخاب تاریخ";
Calendar._TT["DRAG_TO_MOVE"] = "حرکت دهید";
...
Calendar._TT["TIME_PART"] = "بعد از گرفتن دکمه، موس را به طرفين بکشيد<br/>يا از کليک و يا شيفت + کليک استفاده نماييد.";
